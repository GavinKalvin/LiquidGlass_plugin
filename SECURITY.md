...
Safeguards in v1.5.16 include exact runtime locking, process-ID verification, AppKit main-thread execution, full-window candidate validation, original-alpha restoration, and a disk crash sentinel.
